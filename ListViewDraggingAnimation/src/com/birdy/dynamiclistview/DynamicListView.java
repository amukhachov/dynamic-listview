...
public class DynamicListView extends ListView {
    ...
    private OnItemMovedToTopListener itemMovedToTopListener = OnItemMovedToTopListener.VOID_ON_ITEM_MOVED_TO_TOP_LISTENER;
    ...
    private AdapterView.OnItemLongClickListener mOnItemLongClickListener =
            new AdapterView.OnItemLongClickListener() {
                public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int pos, long id) {
                	itemMovedToTopListener.onActivated();
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mCellIsMobile) {
                    ...
                    itemMovedToTopListener.onItemMove(getCurrentItem(), isTopReached());
    ...
    private void touchEventsEnded () {
        ...
        if (mCellIsMobile|| mIsWaitingForScrollFinish) {
            ...
            boolean isOnTop = isTopReached();
            itemMovedToTopListener.onDeactivated(getCurrentItem(), isOnTop);
    ...
    public boolean handleMobileCellScroll(Rect r) {
        ...
        if (hoverViewTop + hoverHeight >= height - getResources().getDimension(R.dimen.list_item_height) && (offset + extent) < range) {
            smoothScrollBy(mSmoothScrollAmountAtEdge, 0);
            return true;
        }
    ...
    private boolean isTopReached() {
    	return mHoverCellCurrentBounds.top < mHoverCellCurrentBounds.height() / 2;
    }
    ...
    public void setOnItemMovedToTopListener(OnItemMovedToTopListener itemMovedToTopListener) {
    	this.itemMovedToTopListener = itemMovedToTopListener;
    }
    
    private String getCurrentItem() {
    	return ((StableArrayAdapter) getAdapter()).getItem(getPositionForID(mMobileItemId)).toString();
    }
    ...
    public interface OnItemMovedToTopListener {
    	OnItemMovedToTopListener VOID_ON_ITEM_MOVED_TO_TOP_LISTENER = new OnItemMovedToTopListener() {
			@Override
    	...
    	void onActivated();
    	void onDeactivated(String item, boolean isOnTop);
    	
    	void onItemMove(String item, boolean isOnTop);
